...
public final class Constants {
    ...
    public static final double VISION_M_CLOSE = 0;
    public static final double VISION_B_CLOSE = 0;

    public static final double VISION_M_LONG = 0;
    public static final double VISION_B_LONG = 0;
