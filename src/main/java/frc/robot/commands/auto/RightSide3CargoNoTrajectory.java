...
public class RightSide3CargoNoTrajectory extends SequentialCommandGroup {
    ...
    public RightSide3CargoNoTrajectory(
        ...
        addCommands(
                ...
                // new DriveStraightDistance(-AutoConstants.CLOSE_CARGO_PICKUP_TO_TURN_DIST,
                // driveTrain),
                // Turn square to the fender.
                // new DriveTurnToRelativeAngle(() -> AutoConstants.TURN_TO_FENDER_SMALL_ANGLE,
                // driveTrain),
                // Drive to fender with timeout because we may hit and not reach distance.
                // new DriveStraightDistance(-AutoConstants.AFTER_TURN_DRIVE_TO_FENDER_DIST,
